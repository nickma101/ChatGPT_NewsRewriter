...
"""
output_data = []
# old_prompt = "Please rewrite the text below according to the following rules: Most importanty, make the text easier to understand so that a ten-year-old has no problem understanding it. Make all sentences shorter. Remove jargon and complicated words wherever possible. Keep at least five facts from the original article. The new text should not be dramatically shorter."
...
for doc in documents[:50]:
    ...
    output_filename = "data/output_articles" + dateString + ".json"
